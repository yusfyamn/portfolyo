...
const Spotlight = () => {
  ...
  const spotlightItems = [
    { name: "Courtyard Stillness", img: "/terrene/spotlight/spotlight-img-1.jpg" },
    { name: "Blue Horizon", img: "/terrene/spotlight/spotlight-img-2.jpg" },
    { name: "Stone Quiet", img: "/terrene/spotlight/spotlight-img-3.jpg" },
    { name: "Amber Niche", img: "/terrene/spotlight/spotlight-img-4.jpg" },
    { name: "Earthen Shelf", img: "/terrene/spotlight/spotlight-img-5.jpg" },
    { name: "Reflective White", img: "/terrene/spotlight/spotlight-img-6.jpg" },
    { name: "Desert Edge", img: "/terrene/spotlight/spotlight-img-7.jpg" },
    { name: "Soft Passage", img: "/terrene/spotlight/spotlight-img-8.jpg" },
    { name: "Water Column", img: "/terrene/spotlight/spotlight-img-9.jpg" },
    { name: "Golden Retreat", img: "/terrene/spotlight/spotlight-img-10.jpg" },
  ];
    ...
    <section className="spotlight" ref={spotlightRef}>
      <div className="spotlight-inner">
        ...
        <div className="spotlight-bg-img">
          <img src="/terrene/spotlight/spotlight-img-1.jpg" alt="" />
        </div>
      </div>
      <div
