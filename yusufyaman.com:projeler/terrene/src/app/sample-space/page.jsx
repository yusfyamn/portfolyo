      ...
      <div className="page sample-space">
        <section className="sample-space-hero">
          <div className="sample-space-hero-img">
            <img src="/terrene/sample-space/hero.jpg" alt="Arcade Residence Lisbon" />
          </div>
          ...
          <div className="container">
            ...
            <div className="sample-space-col">
              ...
              <div className="sample-space-details-img">
                <img src="/terrene/sample-space/sample-space-1.jpg" alt="" />
              </div>
            </div>
          </div>
        </section>
        <section className="sample-space-details sample-space-details-2">
          <div className="container">
            ...
            <div className="sample-space-col">
              ...
              <div className="sample-space-details-img">
                <img
                  src="/terrene/sample-space/sample-space-2.jpg"
        ...
        <CTAWindow
          img="/terrene/sample-space/next-project.jpg"
          header="Next Project"
